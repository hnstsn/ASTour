...
<%@ include file="../include/bootstap_collect.jsp"%>
		...
		$(document).ready(function() {
			...
			$("#contact_sub").click(function() {
				...
				var contact_image=$('#contact_image').val(); //이미지
			});
		});
						...
						<form class="white-row" method="post">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-4" id="selectview">
										...
										<select class="form-control" id="contact_select">
									...
									<div class="col-md-4" id="view">
										<label>태그*</label>
										<input type="text" class="form-control" name="contact_tag" id="contact_tag" value="">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									<div class="col-md-12">
										<label>이미지사진</label>
										<input type="file" value="" class="form-control" name="contact_image" id="contact_image">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									<div class="col-md-12">
										<label>Message *</label>
										<textarea maxlength="5000" rows="10" class="form-control" name="contact_message" id="contact_message"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
								<button type="button" class="btn btn-primary btn-lg" id="contact_sub">버튼</button>
								</div>
							</div>
						</form>
