...
<!-- REVOLUTION SLIDER -->
<link href="${path}/resources/assets/plugins/revolution-slider/css/settings.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${path}/resources/assets/plugins/mediaelement/build/mediaelement-and-player.min.js"></script>

<!-- REVOLUTION SLIDER -->
<script type="text/javascript" src="${path}/resources/assets/plugins/revolution-slider/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="${path}/resources/assets/plugins/revolution-slider/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="${path}/resources/assets/js/slider_revolution.js"></script>
